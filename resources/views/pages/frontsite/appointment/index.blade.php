                ...
                <form action="" class="mt-8 space-y-5">
                    ...
                    <label class="block">
                        <select
                            ...
                            placeholder="Level"
                        >
                            <option value="" disabled selected class="hidden">Forwarder</option>
                            <option value="2022 Yusen">2022 Yusen</option>
                            <option value="2022 Trancy-glorios">2022 Trancy-glorios</option>
                            <option value="2022 MGL">2022 MGL</option>
                        </select>
                    </label>
                    ...
                    <label class="block">
                        <select
                            ...
                            placeholder="Level"
                        >
                            <option value="" disabled selected class="hidden">Place Lot</option>
                            <option value="Lot 7">Lot 7</option>
                            <option value="Lot 8">Lot 8</option>
                            <option value="Lot 206">Lot 206</option>
                            <option value="Lot 242">Lot 242</option>
                        </select>
                    </label>
