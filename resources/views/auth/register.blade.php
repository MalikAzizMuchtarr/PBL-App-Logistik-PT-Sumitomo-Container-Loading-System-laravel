      ...
      <div class="px-4 lg:px-[91px] pt-10">
        ...
        <div class="flex flex-col justify-center py-14 h-full lg:min-h-screen">
            <h2 class="text-[#1E2B4F] text-4xl font-semibold leading-normal">
                Sumitomo Loading System <br />
                Supplay Chain Loading System
            </h2>
          <div class="mt-12">
            <!-- Form input -->
...
Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cum placeat fuga eligendi commodi non voluptatem aspernatur repellendus et quo ut! Ea obcaecati corrupti ipsam expedita vel minus dolor ex quisquam.
            </p>
            <div class="flex-shrink-0 group block mt-7">
              <div class="flex items-center">
                ...
                <div class="ml-5">
                  <p class="font-medium text-[#1E2B4F]">Pak lorem</p>
                  <p class="text-sm text-[#AFAEC3]">CEO</p>
                </div>
              </div>
            </div>
          </div>
