        ...
        <div class="flex justify-between h-16">
            <div class="flex flex-auto justify-between">
                ...
                <a href="{{ route('index') }}" class="flex-shrink-0 flex items-center">
                    <img class="h-12 lg:h-16 w-auto" src="{{ asset('/assets/frontsite/images/logo1.png') }}" alt="Meet Doctor Logo"/>
                </a>
                ...
                <div class="hidden lg:ml-6 lg:flex lg:space-x-12">
                    ...
                    <a href="{{ route('appointment.index') }}" class="text-[#1E2B4F] relative hover:text-gray-500 inline-flex items-center px-1 pt-1 text-lg font-medium">
                        Appointment
                    </a>
            ...
            <div class="hidden lg:ml-10 lg:flex lg:items-center border-l pl-4 pt-2">
                <div x-data="{ profileDekstopOpen: false }" class="ml-3 relative">
                    <div>
                        ...
                        <!-- focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 -->
                            ...
                            <div class="text-right mr-5">
                                ...
                                <div class="text-sm text-[#AFAEC3]">Karyawan</div>
                            </div>
                            <img
                    ...
                    <div
                        ...
                        tabindex="-1"
                    >
                        <a href="#" class="block px-4 py-2 text-sm text-[#1E2B4F] hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-0">
                                Your Profile
                        </a>
                        <a href="#" class="block px-4 py-2 text-sm text-[#1E2B4F] hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-1">
                            Settings
                        </a>
                        <a href="#" class="block px-4 py-2 text-sm text-[#1E2B4F] hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-1">
                            Dashboard
