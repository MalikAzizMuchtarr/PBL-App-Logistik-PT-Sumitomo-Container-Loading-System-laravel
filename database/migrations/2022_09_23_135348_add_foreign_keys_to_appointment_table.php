...
class AddForeignKeysToAppointmentTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('appointment', function (Blueprint $table) {
            ...
            ->onDelete('CASCADE');
            $table->foreign('port_of_origin_id','fk_appointment_to_port_of_origin')
            ->references('id')->on('port_of_origin')->onUpdate('CASCADE')
            ->onDelete('CASCADE');
        });
    }
    ...
    public function down()
    {
        Schema::table('appointment', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_appointment_to_port_of_origin');
        });
    }
}
